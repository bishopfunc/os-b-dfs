...
const (
	...
	DFS_NotifyInvalid_FullMethodName = "/dfs.DFS/NotifyInvalid"
	DFS_CreateDir_FullMethodName     = "/dfs.DFS/CreateDir"
)
...
func (c *dFSClient) NotifyInvalid(ctx context.Context, opts ...grpc.CallOption) (DFS_NotifyInvalidClient, error) {
	stream, err := c.cc.NewStream(ctx, &DFS_ServiceDesc.Streams[0], DFS_NotifyInvalid_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *dFSClient) CreateDir(ctx context.Context, in *CreateDirRequest, opts ...grpc.CallOption) (*CreateDirResponse, error) {
	out := new(CreateDirResponse)
	err := c.cc.Invoke(ctx, DFS_CreateDir_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedDFSServer) CreateDir(context.Context, *CreateDirRequest) (*CreateDirResponse, error) {
...
func _DFS_CreateDir_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreateDirRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DFSServer).CreateDir(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DFS_CreateDir_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DFSServer).CreateDir(ctx, req.(*CreateDirRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var DFS_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _DFS_CreateDir_Handler,
		},
	},
